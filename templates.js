...
**VARIABLES**
    ...
    [
        ...
        {
            "name":       "Pre-Processor, Special, Addition",
            "scope":      "meta.preprocessor, meta.annotation, keyword.other.import, keyword.control.import, constant.character, markup.inserted, markup.inserted.diff",
            "foreground": "var(c5)",
        },
        {
            "name":       "Errors, Removal",
            "scope":      "invalid.deprecated, markup.deleted, markup.deleted.diff",
            "foreground": "var(c6)",
        },
        {
            "name":       "Comment",
...
style.syntax["function"] = scheme.c2
`,
}
